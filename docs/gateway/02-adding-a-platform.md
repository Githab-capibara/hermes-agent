# 02. Adding a platform

- **Status:** Accepted
- **Date:** 2026-08-25
- **Type:** Contributor guide
- **Audience:** Platform adapter authors
- **Source files:** `gateway/platforms/base.py`, `gateway/platforms/`, `plugins/platforms/`
- **Related:** [Gateway overview](01-overview.md), [Plugins overview](../plugins/01-overview.md), [Session Lifecycle](../architecture/01-session-lifecycle.md)
