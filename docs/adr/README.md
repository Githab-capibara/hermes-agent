...
Hermes Agent — short, numbered, append-only documents that capture
...
- A trade-off between two viable designs where the loser is not
  ...
  mechanism, prompt-cache boundary placement).
...
- File name kebab-case, derived from the title: `07-c2-framework-selection.md`.
...
| # | Title | Status |
|---|---|---|
| [01](01-plugin-manager-state-scoping.md) | Plugin manager state scoping by Hermes home | Accepted |
